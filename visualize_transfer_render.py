...
prediction_dir = "/home/hanxiao/Desktop/Research/proj-qqtt/proj-QQTT/exp_results/transfer_from_case_gaussian/output_out_domain_transfer"
human_mask_path = (
...
for dir_name in dir_names:
    from_case_name = dir_name.split("/")[-1].split("_to_")[0]
    to_case_name = dir_name.split("/")[-1].split("_to_")[1]
    ...
    for i in range(3):
        ...
        video_writer = cv2.VideoWriter(
            f"{prediction_dir}/{from_case_name}_to_{to_case_name}/{i}_integrate.mp4",
            fourcc,
            FPS,
            (width, height),
        )
        ...
        for frame_idx in range(frame_len):
            render_path = f"{prediction_dir}/{from_case_name}_to_{to_case_name}/{i}/{frame_idx:05d}.png"
