...
prediction_path = "/home/hanxiao/Desktop/Research/proj-qqtt/baselines/Spring-Gaus/exp"
output_file = "results/final_track_SG.csv"
...
for dir_name in dir_names:
    try:
        ...
        for frame_idx in range(frame_len):
            pcd_path = f"{prediction_path}/{case_name}/evaluations/0/simulate_pred/pred_{frame_idx}.ply"
