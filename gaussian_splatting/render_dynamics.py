...
def rollout(xyz_0, rgb_0, quat_0, opa_0, ctrl_pts, n_steps, device='cuda'):
    ...
    # TODO: debug with subsampled gaussians
    # n_samples = 10_000
    # xyz_0 = xyz_0[:n_samples]
    # rgb_0 = rgb_0[:n_samples]
    # quat_0 = quat_0[:n_samples]
    # opa_0 = opa_0[:n_samples]
    ...
    for i in tqdm(range(1, n_steps), desc="Rollout progress", dynamic_ncols=True):
        ...
        # weights = knn_weights(prev_particle_pos, all_pos, K=16)
            
        # all_pos, all_rot, _ = interpolate_motions_feng(
        #     bones=prev_particle_pos,
        #     motions=cur_particle_pos - prev_particle_pos,
        #     relations=relations,
        #     weights=weights,
