...
def render_sets(dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool, separate_sh: bool, remove_gaussians: bool = False, name: str = "dynamic"):
    with torch.no_grad():
        ...
        output_path = './output_dynamic_only_first'
        ...
        # rollout
        ctrl_pts_path = os.path.join('./experiments_only_first', name, "inference.pkl")
...
if __name__ == "__main__":
    ...
    with open('./rendering_finished_dynamic_only_first.txt', 'a') as f:
