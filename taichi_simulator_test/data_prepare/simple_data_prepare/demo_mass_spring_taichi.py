...
def demo1(spring_K=3e3):
    ...
    np.save(f"/home/hanxiao/Desktop/Research/proj-qqtt/proj-QQTT/taichi_simulator_test/simple_data_prepare/table_{spring_K}.npy", points_trajectories)
