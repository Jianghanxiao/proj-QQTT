...
class SpringMassSystem_taichi:
    def __init__(
        ...
        # Initialize the spring_Y for all springs
        self.spring_Y = ti.field(dtype=ti.f32, shape=self.n_springs)
        self.spring_Y.from_numpy(spring_Y)
    ...
    def substep(self):
        ...
        for idx_spring in range(self.n_springs):
            ...
            force = self.spring_Y[idx_spring] * (dis.norm() / self.rest_lengths[idx_spring] - 1) * d
...
def demo1():
    ...
    points_trajectories = [init_vertices]
